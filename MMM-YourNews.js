    ...
    getDom: function() {
        ...
        if (keys.length > 0) {
            ...
            function timevor(date) {
                ...
                if (Math.round(seconds / (60 * 60 * 24 * 365.25)) >= 2) return "<font color=#CC0033>vor " + Math.round(seconds / (60 * 60 * 24 * 365.25)) + " Jahren</font>";
                else if (Math.round(seconds / (60 * 60 * 24 * 365.25)) >= 1) return "<font color=#FF0033>vor 1 Jahr</font>";
                else if (Math.round(seconds / (60 * 60 * 24 * 30.4)) >= 2) return "<font color=#99FF99>vor " + Math.round(seconds / (60 * 60 * 24 * 30.4)) + " Monate</font>";
                else if (Math.round(seconds / (60 * 60 * 24 * 30.4)) >= 1) return "<font color=#CCFF99>vor 1 Monat</font>";
                else if (Math.round(seconds / (60 * 60 * 24 * 7)) >= 2) return "<font color=#99FF33>vor " + Math.round(seconds / (60 * 60 * 24 * 7)) + " Wochen</font>";
                else if (Math.round(seconds / (60 * 60 * 24 * 7)) >= 1) return "<font color=#66CC00>vor 1 Woche</font>";
                else if (Math.round(seconds / (60 * 60 * 24)) >= 2) return "<font color=#66FFFF>vor " + Math.round(seconds / (60 * 60 * 24)) + " Tagen</font>";
                else if (Math.round(seconds / (60 * 60 * 24)) >= 1) return "<font color=#33CCFF>vor 1 Tag</font>";
                else if (Math.round(seconds / (60 * 60)) >= 2) return "<font color=#FFFF33>vor " + Math.round(seconds / (60 * 60)) + " Stunden</font>";
                else if (Math.round(seconds / (60 * 60)) >= 1) return "<font color=#FFFF99>1 Stunde vor</font>";
                else if (Math.round(seconds / 60) >= 2) return "<font color=#FF3333>vor " + Math.round(seconds / 60) + " Minuten</font>";
                else if (Math.round(seconds / 60) >= 1) return "<font color=#FF6666>vor 1 Minute</font>";
                else if (seconds >= 2) return this.translate("<font color=#FFF>vor 2 Sekunden</font>");
